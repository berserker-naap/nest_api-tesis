import { Body, Controller, Post, Put, Delete, Param, Get, Patch } from '@nestjs/common';
...
export class MultitablaController {
  ...
  @Post()
  @Auth()
  create(@Body() dto: CreateUpdateMultitablaDto, @GetUsuario() user: Usuario, @GetClientIp() ip: string) {
